...
## 💻 협업 방식 및 Git 컨벤션 규칙
1️⃣ 매일 오후 1시부터 팀미팅을 진행하였고, 필요한 경우 유연하게 회의 시간을 변경함. 또한 팀미팅 이후 5시까지를 Core Time으로 지정함

2️⃣ 2명 이상 Approve 했을 때  Merge가 가능하도록 룰을 적용함

3️⃣ 기획, 작업, 개선 사항, 버그 수정, 새로 추가될 기능 등을 Github 레포지토리 Issue의 템플릿 코드로 지정하고, Issue에서 새로운 브랜치를 생성하여 작업을 진행함
