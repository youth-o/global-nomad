# 🎊 Global-Nomad Project-Team16 🎊

> 코드잇 스프린트 : 프론트 엔드 4기 Part4 - 16팀
>
> 개발 기간: 2024.5.16 ~ 6.26
...
<div style="text-align: center;">
  <img src="https://github.com/user-attachments/assets/f1a3fa7b-8ec0-470c-b040-fc637831ed6f" width="100%" height="100%">
</div>
...
<table>
  <tbody>
    <tr>
      ...
      <img width=200px src="https://github.com/user-attachments/assets/c12c55b5-3e60-4de3-b4f7-e334c2755442" alt=""/><br />
      <sub><b>[FE] 김태진</b></sub></a><br /></td>
      <td align="center"><a href="https://github.com/changmin6362">
      <img width=200px src="https://github.com/user-attachments/assets/ca8dbfc5-fc9c-44e1-b1d7-028491e5912b" alt=""/><br />
      <sub><b>[FE] 김창민</b></sub></a><br /></td>
      <td align="center"><a href="https://github.com/dtc03003">
      <img width=200px src="https://github.com/user-attachments/assets/51553294-43d3-4680-a939-5e7c4d6c8421" alt=""/><br />
      ...
      <img width=200px src="https://github.com/user-attachments/assets/a12e5b5d-3fa6-4a47-bab0-fd0ee5f1c61c" alt=""/><br />
...
## 💻 협업 방식 및 Git 컨벤션 규칙
1️⃣ 매일 오후 3시부터 30분간 팀미팅을 진행하였고, 필요한 경우 유연하게 회의 시간을 변경함. 또한 팀미팅 이후 3시간을 Core Time으로 지정함

2️⃣ 1명 이상 Approve 했을 때  Merge가 가능하도록 룰을 적용함

3️⃣ 기획, 작업, 개선 사항, 버그 수정, 새로 추가될 기능 등을 Github 레포지토리 Issue의 템플릿 코드로 지정하여 작업을 진행함

4️⃣ 노션에 Github Issue를 연동하여 추가된 사항을 바로 확인할 수 있도록 함
